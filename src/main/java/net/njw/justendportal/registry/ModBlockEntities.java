...
public final class ModBlockEntities {
    ...
    public static final Supplier<BlockEntityType<ArrivalPlatformBlockEntity>> ARRIVAL_PLATFORM = BLOCK_ENTITY_TYPES.register("arrival_platform", () -> new BlockEntityType<>(ArrivalPlatformBlockEntity::new, false, ModBlocks.ARRIVAL_PLATFORM.get()));
