...
public final class ModBlocks {
    ...
    public static final DeferredBlock<LinkedEndPortalBlock> LINKED_END_PORTAL = BLOCKS.registerBlock("linked_end_portal", LinkedEndPortalBlock::new, () -> BlockBehaviour.Properties.ofFullCopy(Blocks.END_PORTAL));
