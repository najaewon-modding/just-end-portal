...
public record GeneratorBobProperty() implements RangeSelectItemModelProperty {
    ...
    @Override public float get(ItemStack stack, @Nullable ClientLevel level, @Nullable ItemOwner owner, int seed) { double seconds = System.nanoTime() / 1_000_000_000.0; return 0.5F + 0.5F * Mth.sin((float) (seconds * 3.2)); }
